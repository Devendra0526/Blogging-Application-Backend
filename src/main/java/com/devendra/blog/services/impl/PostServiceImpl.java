...
import com.devendra.blog.repositories.CategoryRepo;
import com.devendra.blog.repositories.PostRepo;
import com.devendra.blog.repositories.UserRepo;
import com.devendra.blog.services.PostService;
...
public class PostServiceImpl implements PostService {
	...
	public PostDto createPost(PostDto postDto, Integer userId, Integer categoryId) {
		...
		User user = this.userRepo.findById(userId).orElseThrow(()-> new ResourceNotFoundException("User", "Useer id", userId));
	...
	@Override
	public List<PostDto> searchPostByUser(String keyword) {
